...
if __name__ == '__main__':
    ...
    print("Total intersections: {}".format(len(obj_fun.traffic.intersections)))


    out_file = "./submission.score={}_{}_num_proc={}_num_iter={}.csv".format(results.best_fitness,datetime.now().strftime("%Y-%m-%d-%H.%M.%S.%f"), num_processes, num_iterations)
